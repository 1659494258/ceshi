        ...
        <el-card>
          <template #header>
            <div class="buttonList">
              <el-button @click="addTodo">新增申请</el-button>
              <el-button @click="signOpinion">签署意见</el-button>
              <el-button @click="submitReview">提交审核</el-button>
              <el-button @click="cancelApply" type="danger" plain>取消申请</el-button>
            </div>
          </template>
          <div style="margin-top: 20px">
            ...
            <el-popover placement="right" :width="350" trigger="hover">
              ...
              <el-table-column prop="policyName" label="产品政策名称" width="180" />
...
const cancelApply = () => {
  if (currentTodo.value.flowInstanceId) {
    productFlowCancel(currentTodo.value.flowInstanceId).then(res => {
      console.log('productFlowCancel', res)
      getTodoList()
      getDoneList()
      ElNotification({
        title: '成功',
